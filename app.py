...
# =====================================================
# CHAT ROUTE WITH RECOMMENDATIONS & THERAPISTS
# =====================================================
...
def chat():
    try:
        ...
        # Recommendations only for low/sad/stressed/high/critical
        recommendations = []
        if emotion in ["sad","breakup","stress","angry"] or risk in ["medium","high","critical"]:
            recommendations = [
                "Take deep breaths",
        ...
        # Therapist suggestions only for high/critical risk
        therapists = []
        if risk in ["high","critical"]:
            # TODO: Integrate Google Maps API here
            therapists = [
                {"name":"Dr. Smith","city":"New York","contact":"+123456789"},
                {"name":"Dr. Lee","city":"San Francisco","contact":"+987654321"}
            ]
